<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StartEnjoy.aspx.cs" Inherits="WebApplication5.Forms.StartEnjoy" %>
  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="Budget.aspx">SET BUDGET</a></li>
        <li class="active"><a href="StartEnjoy.aspx">START  ENJOY</a></li>
      </ul><br>
    </div>
    <div class="col-sm-offset-0">
    
    <form id="StartEnjoyForm" runat="server" >
      <asp:Table ID="Table1" runat="server" Width="918px" 
          style="margin-left: 712px; margin-top: 102px;" Height="536px">
            <asp:TableRow Font-Bold="true" HorizontalAlign="Justify">
                   <asp:TableCell ></asp:TableCell>
                   <asp:TableCell>
                       <asp:Label ID="Label1" runat="server" Text="YOUR NEXT PC..." Font-Size="100PX"></asp:Label>
                   </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
               <asp:TableCell>
               ...
               <asp:TableCell>
                 <asp:TextBox runat="server" ID="tbCategory"></asp:TextBox>
               </asp:TableCell>
               </asp:TableRow>
               <asp:TableRow>
                   <asp:TableCell>
                       <asp:Label ID="Label3" runat="server" Text="CPU"></asp:Label> 
                   </asp:TableCell>
                   <asp:TableCell>
                       <asp:TextBox runat="server" ID="tbCpu"></asp:TextBox>
                   </asp:TableCell>
               </asp:TableRow>
               <asp:TableRow>
                   <asp:TableCell>
               ...
               <asp:TableRow>
                   ...
                   <asp:TableCell>
                       <asp:TextBox runat="server" ID="tbRam"></asp:TextBox> 
                   </asp:TableCell>
               </asp:TableRow>
      </asp:Table>
    </form>
